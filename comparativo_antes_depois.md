...
| **Medição de latência/tokens** | Qualitativa apenas ('Gemini mais rápido ~1-2s, GPT ~2-4s'), sem tabela | Automática por turno — latência média mínima observada: 0.94 s (gpt-4o-mini (T=0.3)) |
